...
<body>
	<div class="header">
		<div class="header_top">
			<div class="logo">
				<a href="index.action"><img src="./images/logo1.png" alt="" /></a>
			</div>
				...
				<div class="login">
					<span>
						...
						<s:else>
							...
							<a href="logout.action"  style="float: right;">注销</a>
						</s:else>
					</span>
				</div>
				<div class="clear"></div>
		...
		<div class="menu">
			<ul id="dc_mega-menu-orange" class="dc_mm-orange">
				<li><a href="index.action">商城首页</a></li>
				<li><a href="productList.action">商品分类</a>
					<ul>
